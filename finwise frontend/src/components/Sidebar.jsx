  ...
  return (
    <>
      ...
      >
        ...
        <div className="space-y-2">
          {menu.map((item, index) => (
            <Link
              ...
              to={item.path}
              onClick={() => setOpen(false)}
              className="flex items-center gap-4 p-4 rounded-2xl hover:bg-purple-700 transition"
            >
        ...
        {/* LOGOUT - Moved up since dark mode is removed */}
        <button
          onClick={handleLogout}
          className="w-full mt-6 bg-red-600 hover:bg-red-700 p-4 rounded-2xl flex items-center justify-center gap-3 font-bold"
        >
          <FaSignOutAlt />
          Logout
        </button>
